...
sort_add = dbc.DropdownMenu(
    ...
    nav=True,
    in_navbar=True,
    label="Sort Instructors by A to Z",
                        ...
                        html.Div( 
                            [
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='instructorhome_titlefilter_atoz',
                                ...
                                html.Div(
                                    ...
                                    id='instructorhome_instructorlist_atoz'
                                )
                            ]
                        )
                    ]
...
@app.callback(
    [
        Output('instructorhome_instructorlist_atoz', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('instructorhome_titlefilter_atoz', 'value'),
    ]
)
def instructorhome_loadinstructorlist(pathname, searchterm):
    if pathname == '/instructors/instructors_home_atoz':
        ...
        sql += " ORDER BY instructor_fname, instructor_lname ASC"

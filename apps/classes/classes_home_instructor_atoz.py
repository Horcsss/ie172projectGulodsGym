                        ...
                        html.Div( # Create section to show list of movies
                            [
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='classhome_titlefilter_instructor_atoz',
                                ...
                                html.Div(
                                    ...
                                    id='classhome_classlist_instructor_atoz'
                                )
                            ]
                        )
                    ]
...
@app.callback(
    [
        Output('classhome_classlist_instructor_atoz', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('classhome_titlefilter_instructor_atoz', 'value'),
    ]
)
def classhome_loadclasslist(pathname, searchterm):
    if pathname == '/classes/classes_home_instructor_atoz':
        ...
        sql = """ 
            ...
            ORDER BY instructor_name DESC;  -- Order by instructor's name Z-A
        """

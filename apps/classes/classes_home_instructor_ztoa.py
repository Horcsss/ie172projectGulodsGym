                        ...
                        html.Div( # Create section to show list of movies
                            [
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='classhome_titlefilter_instructor_ztoa',
                                ...
                                html.Div(
                                    ...
                                    id='classhome_classlist_instructor_ztoa'
                                )
                            ]
                        )
                    ]
...
@app.callback(
    [
        Output('classhome_classlist_instructor_ztoa', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('classhome_titlefilter_instructor_ztoa', 'value'),
    ]
)
def classhome_loadclasslist(pathname, searchterm):
    if pathname == '/classes/classes_home_instructor_ztoa':
        ...
        sql = """ 
            ...
            ORDER BY instructor_fname DESC;  -- Order by instructor's name
        """

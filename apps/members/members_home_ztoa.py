...
sort_add = dbc.DropdownMenu(
    ...
    nav=True,
    in_navbar=True,
    label="Sort Members from Z to A (First Name)",
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='memberhome_titlefilter_ztoa',
...
@app.callback(
    [
        Output('memberhome_memberlist_ztoa', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('memberhome_titlefilter_ztoa', 'value'),
    ]
)

def memberhome_loadmemberlist(pathname, searchterm):
    if pathname == '/members/members_home_ztoa':
        ...
        sql += " ORDER BY member_fname DESC"

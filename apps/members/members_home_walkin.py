...
sort_add = dbc.DropdownMenu(
    ...
    nav=True,
    in_navbar=True,
    label="Sort Members by Membership Type (Walk-in)",
                        ...
                        html.Div( # Create section to show list of movies
                            [
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='memberhome_titlefilter_walkin',
                                ...
                                html.Div(
                                    ...
                                    id='memberhome_memberlist_walkin'
                                )
                            ]
                        )
                    ]
...
@app.callback(
    [
        Output('memberhome_memberlist_walkin', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('memberhome_titlefilter_walkin', 'value'),
    ]
)

def memberhome_loadmemberlist(pathname, searchterm):
    if pathname == '/members/members_home_walkin':
        ...
        sql += " ORDER BY CASE WHEN membership = 'Walk-in' THEN 0 ELSE 1 END, member_fname"

...
sort_add = dbc.DropdownMenu(
    ...
    nav=True,
    in_navbar=True,
    label="Sort Members by Membership Type (Member)",
                        ...
                        html.Div( # Create section to show list of members
                            [
                                                ...
                                                dbc.Row(
                                                    [
                                                        ...
                                                        dbc.Col(
                                                            dbc.Input(
                                                                type='text',
                                                                id='memberhome_titlefilter_member',
                                ...
                                html.Div(
                                    ...
                                    id='memberhome_memberlist_member'
                                )
                            ]
                        )
                    ]
...
@app.callback(
    [
        Output('memberhome_memberlist_member', 'children')
    ],
    [
        Input('url', 'pathname'),
        Input('memberhome_titlefilter_member', 'value'),
    ]
)

def memberhome_loadmemberlist(pathname, searchterm):
    if pathname == '/members/members_home_member':
        ...
        sql += " ORDER BY CASE WHEN membership = 'Member' THEN 0 ELSE 1 END, member_fname"
